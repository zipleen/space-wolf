...
Menu_def::Menu_def()
{
	...
	this->menu_definicoes.push_back("800 X 600");
	this->menu_definicoes.push_back("1024 X 768");
	this->menu_definicoes.push_back("1280 X 1024");
	this->menu_definicoes.push_back("Voltar ao menu anterior");
	
}


void Menu_def::handleKeyPress (SDL_keysym *key, bool value)
{
	switch(key->sym)
	{
		case SDLK_UP:
